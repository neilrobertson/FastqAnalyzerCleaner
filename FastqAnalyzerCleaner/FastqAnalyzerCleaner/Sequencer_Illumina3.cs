/// <copyright file="SeqeuencerIllumina3.cs" author="Neil Robertson">
...
{
    class Sequencer_Illumina3 : ISequencer
    {
        public static ISequencer sequencer = new Sequencer_Illumina3();
